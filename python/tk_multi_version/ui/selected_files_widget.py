...
class Ui_SelectedFilesWidget( object ):
    def setupUi( self, selected_ui ):
        ...
        self.widget.setHorizontalHeaderLabels( [ 'Project', 'Version' , 'Description' ,'Mov_colorspace', '23.976'] )
        self.widget.horizontalHeader().resizeSection( 0, 70 )
        self.widget.horizontalHeader().resizeSection( 1, 180 )
        self.widget.horizontalHeader().resizeSection( 2, 200 )
        self.widget.horizontalHeader().resizeSection( 3, 150 )
        self.widget.horizontalHeader().resizeSection( 4, 10 )
